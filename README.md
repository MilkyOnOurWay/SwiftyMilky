...
## `프로젝트 소개`
### 🥛 다양한 우유 옵션 및 디카페인 메뉴가 있는 카페를 지도로 쉽게 알려주는 서비스, 밀키웨이를 소개합니다.
> 커피를 좋아하지만 카페인에 약해 디카페인 커피를 제공하는 카페를 찾아다니는 누군가를 위해, </br>
라떼를 좋아하지만 우유를 잘 소화하지 못하는 누군가를 위해, </br>
다양한 커피 옵션을 제공하는 카페를 쉽고 편리하게 제공하는 서비스, **밀키웨이** 입니다.
...
# 📄 IA 
<img src="https://user-images.githubusercontent.com/68267763/104697665-74e50400-5753-11eb-8b58-39b1a3f2a547.png" height="600"/>
...
![Xcode](https://img.shields.io/badge/xcode-v12.3-blue?logo=xcode)
![CocoaPods](https://img.shields.io/badge/CocoaPods-v1.10.0-red?logo=CocoaPods)
![iOS](https://img.shields.io/badge/iOS-14.3-green.svg)
...
* 메일 할 일을 슬랙에 정리합니다.
* 기본적으로 1시부터 6시까지 게더로 출근 및 퇴근을 합니다.
